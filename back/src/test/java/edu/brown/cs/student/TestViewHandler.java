...
public class TestViewHandler {
  ...
  @Test
  public void testNoLoad() throws IOException {
    String apiCall = "viewcsv";
    ServerFailureResponse noCSV =
        new ServerFailureResponse(
            "error_datasource", "Cannot retrieve CSV. CSV may not be loaded.");
    Assert.assertEquals(this.deserialize(apiCall).get("result"), noCSV.response_type());
    Assert.assertEquals(this.deserialize(apiCall).get("error_type"), noCSV.error_type());
    Assert.assertEquals(this.deserialize(apiCall).get("details"), noCSV.details());
  }

  @Test
  public void testIncomeCSV() throws IOException, FactoryFailureException {
  ...
  @Test
  public void testCensusCSV() throws IOException, FactoryFailureException {
  ...
  @Test
  public void testStarsCSV() throws IOException, FactoryFailureException {
